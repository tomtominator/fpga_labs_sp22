...
#######set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { FPGA_SERIAL_TX }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
#######set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { FPGA_SERIAL_RX }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
