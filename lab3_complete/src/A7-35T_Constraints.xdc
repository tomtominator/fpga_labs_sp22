...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { CLK_125MHZ_FPGA }];
...
set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { LEDS[5] }]; #IO_L20P_T3_35 Sch=led1_b
